...
# Инлайн кнопки выбора протокола VPN
kb_3 = InlineKeyboardBuilder()
kb_3.button(text="Получить конфиг", callback_data="wg_config")
kb_3.button(text="Инструкция", callback_data="wg_instruction")
kb_3.adjust(2)  # 2 кнопки в каждой строке
ikb3 = kb_3.as_markup()
